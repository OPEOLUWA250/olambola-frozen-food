...
export const SEOConfig = {
  ...
  site: {
    ...
    description: 'Premium quality fish and seafood from the world\'s finest waters',
  ...
  pages: [
    {
      ...
      description: 'Discover premium quality fresh and frozen fish, seafood, and sustainable fishing products from Olambola Foods.',
      keywords: 'frozen fish, seafood delivery, premium fish, fresh frozen fish',
      priority: 1.0,
      changefreq: 'weekly',
    },
    {
      ...
      description: 'Learn about Olambola Foods, our mission for premium quality fish and seafood, and commitment to sustainability.',
    ...
    },
    {
      ...
      description: 'Contact Olambola Foods with questions about our premium fish and seafood products.',
