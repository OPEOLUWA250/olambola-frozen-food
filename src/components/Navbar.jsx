export default function Navbar({ onNavigate }) {
  ...
  return (
    <nav>
      <div className="relative flex items-center justify-center gap-2 md:gap-12 px-0 py-0.5 md:px-12 md:py-5 rounded-3xl backdrop-blur-xl bg-white/20 border-2 border-[#1E40AF]/30 shadow-2xl hover:bg-white/25 transition-all duration-300">
        {/* Navigation Links */}
